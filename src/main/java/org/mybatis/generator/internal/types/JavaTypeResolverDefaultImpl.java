...
public class JavaTypeResolverDefaultImpl implements JavaTypeResolver {
    ...
    public JavaTypeResolverDefaultImpl() {
        ...
        typeMap.put(Types.VARCHAR, new JdbcTypeInformation("VARCHAR", //$NON-NLS-1$
                new FullyQualifiedJavaType(String.class.getName())));
        typeMap.put(Types.OTHER, new JdbcTypeInformation("VARCHAR2", new FullyQualifiedJavaType(String.class.getName())));
        typeMap.put(Types.DECIMAL, new JdbcTypeInformation("NUMBER", new FullyQualifiedJavaType(Long.class.getName())));
